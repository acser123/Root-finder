...
*/
/* Finds roots of expression in function f() below.
Usage:
   rootfinder from to number_of_intervals

Example:
$ rootfinder -1 2 30
result: Bisection: -0.53167895748265436850
result: Bisection: 1.15872847301870973702
Time spent: 0.00031399999999999999
